...
class Mission(models.Model):
    ...
    status = models.CharField(max_length=9, default="Planned", choices=MissionStatusChoices.choices)
    launch_date = models.DateField()
    updated_at = models.DateTimeField(auto_now=True)
    ...
    commander = models.ForeignKey(null=True, blank=True,
                                  to=Astronaut, on_delete=models.SET_NULL, related_name="mission_commander")