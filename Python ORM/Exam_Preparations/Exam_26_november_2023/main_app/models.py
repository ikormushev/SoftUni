...
class Article(models.Model):
    ...
    category = models.CharField(max_length=10, default="Technology", choices=ArticleCategoryChoices.choices)
    authors = models.ManyToManyField(to=Author, related_name="article")
...
class Review(models.Model):
    ...
    author = models.ForeignKey(to=Author, on_delete=models.CASCADE, related_name="review")
    article = models.ForeignKey(to=Article, on_delete=models.CASCADE, related_name="review")
    published_on = models.DateTimeField(auto_now_add=True, editable=False)
