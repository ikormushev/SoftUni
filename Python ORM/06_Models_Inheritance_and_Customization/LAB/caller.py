...
#
# snake = Reptile.objects.create(name="Kaa", species="Python", birth_date=snake_birth_date, sound="Hiss",
#                                scale_type="Scales")
#
# print(f"The snake's age is {snake.age}.")

# Task 7
# v1 = Veterinarian.objects.create(first_name="John", last_name="Doe",
#                                  phone_number="0896625120", license_number="VET123", availability=False)
# print(v1.availability)
#
# v2 = Veterinarian.objects.create(first_name="Alice", last_name="Johnson",
#                                  phone_number="0896529728", license_number="VET789")
